# remit-sdk (Java/Kotlin) — DEPRECATED

> **This package has been deprecated.** Use the [pay CLI](https://pay-skill.com/docs/cli) or [pay SDKs](https://pay-skill.com/docs) instead.
